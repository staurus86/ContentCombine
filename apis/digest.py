...
## Задача
1. Из КАЖДОГО типа отбери 5-7 самых интересных пунктов — дайджест должен быть максимально
   информативным. Бери всё стоящее, проходное и дубли пропусти. Если по типу материалов нет — пропусти раздел.
