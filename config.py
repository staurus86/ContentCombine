...
# Вопросные формулировки, не SEO-ключи: AI Overviews/Нейро/LLM чаще активируются
# на сложные вопросы, сравнения и «что выбрать». Микс: информационные / how-to /
# коммерческие / экспертные / сравнительные / репутационные. RU-срез (по решению
# пользователя 2026-07-05). Ядро стабильное — дельта неделя-к-неделе осмысленна.
CITABILITY_QUERIES = [
    "Что такое SEO в 2026 году и как изменилось продвижение сайтов?",
    "Как продвигать сайт в 2026 году в Яндексе и Google?",
    "Какие SEO-инструменты лучшие в 2026 году?",
    "Какие сервисы нужны SEO-специалисту для полноценной работы?",
    "Какие лучшие сервисы для съёма позиций в Яндексе и Google?",
    "Какие лучшие сервисы анализа конкурентов в SEO?",
    "Какие инструменты использовать для технического SEO-аудита сайта?",
    "Как провести технический аудит сайта: чеклист для SEO?",
    "Что входит в профессиональный SEO-аудит сайта?",
    "Как понять, что SEO-аудит сделан качественно?",
    "Как выбрать SEO-специалиста или SEO-консультанта?",
    "Как нанять SEO-специалиста и не слить бюджет?",
    "Какие вопросы задать SEO-специалисту перед началом работы?",
    "Как проверить компетенции SEO-специалиста?",
    "Какие ошибки чаще всего допускают SEO-специалисты в 2026 году?",
    "Как найти причины падения органического трафика?",
    "Почему сайт потерял позиции в Яндексе и Google?",
    "Как восстановить SEO-трафик после падения?",
    "Как улучшить индексацию большого сайта?",
    "Как оптимизировать сайт с тысячами или миллионами страниц?",
    "Как продвигать интернет-магазин в Яндексе в 2026 году?",
    "Как продвигать сайт услуг в конкурентной нише?",
    "Как продвигать медицинский сайт в Яндексе и Google?",
    "Как продвигать B2B-сайт через SEO?",
    "Как продвигать SaaS-проект через SEO?",
    "Что такое GEO-оптимизация для ChatGPT и нейросетей?",
    "Чем GEO отличается от SEO и AEO?",
    "Что такое AEO и зачем оно нужно бизнесу?",
    ...
    "Как сделать сайт видимым в Perplexity, Gemini и Claude?",
    "Какие факторы влияют на упоминание бренда в нейроответах?",
    "Как проверить видимость бренда в ChatGPT и других ИИ?",
    "Какие сервисы проверяют видимость бренда в AI-поиске?",
    "Как отслеживать упоминания сайта в нейроответах Яндекса и Google?",
    "Как оптимизировать контент под ответы нейросетей?",
    "Как писать статьи, которые цитируют AI Overviews и ChatGPT?",
    "Как защитить бренд от искажений в ответах нейросетей?",
]
...
AUTO_DIGEST_CRON_HOUR = _int_env("AUTO_DIGEST_CRON_HOUR", 20)  # час (МСК) авто-дайджеста в TG-канал
WEEKLY_DIGEST_CRON_HOUR = _int_env("WEEKLY_DIGEST_CRON_HOUR", 19)  # час (МСК) недельного дайджеста, воскресенье
...
SOURCES = [
    ...
    {"name": "Clearscope Blog", "type": "homepage", "url": "https://www.clearscope.io/blog", "url_filter": "/blog/", "interval": 60},
    ...
    {"name": "Scrunch", "type": "homepage", "url": "https://scrunch.com/blog", "url_filter": "/blog/", "interval": 60},
    ...
    {"name": "Botify Blog", "type": "homepage", "url": "https://www.botify.com/blog", "url_filter": "/blog/", "interval": 90},
    ...
    {"name": "Frase Blog", "type": "homepage", "url": "https://www.frase.io/blog/", "url_filter": "/blog/", "interval": 90},
    ...
    {"name": "Nightwatch Blog", "type": "homepage", "url": "https://nightwatch.io/blog/", "url_filter": "/blog/", "interval": 120},
    ...
    {"name": "VentureBeat AI", "type": "rss", "url": "https://venturebeat.com/feed/", "interval": 60},
